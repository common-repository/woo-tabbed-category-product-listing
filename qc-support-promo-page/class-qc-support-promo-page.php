...
if ( ! defined( 'qcld_woo_tabbed_support_path' ) ) {
    define('qcld_woo_tabbed_support_path', plugin_dir_path(__FILE__));
}

if ( ! defined( 'qcld_woo_tabbed_support_url' ) )
    define('qcld_woo_tabbed_support_url', plugin_dir_url( __FILE__ ) );

if ( ! defined( 'qcld_woo_tabbed_img_url' ) )
    define('qcld_woo_tabbed_img_url', qcld_woo_tabbed_support_url . "/images" );
...
if ( ! function_exists( 'qcld_woo_tabbed_include_promo_page_scripts' ) ) {	
	function qcld_woo_tabbed_include_promo_page_scripts( ) {   
        ...
        if( isset($_GET["page"]) && !empty($_GET["page"]) && (   $_GET["page"] == "qcld_woo_tabbed_supports"  ) ){
            ...
            wp_enqueue_style( 'qcld-woo-tabbed-support-style-css', qcld_woo_tabbed_support_url . "css/style.css");

            wp_enqueue_script( 'jquery' );
            wp_enqueue_script( 'jquery-ui-core');
            wp_enqueue_script( 'jquery-ui-tabs' );
            wp_enqueue_script( 'jquery-woo_tabbed-form-processor', qcld_woo_tabbed_support_url . 'js/support-form-script.js',  array('jquery', 'jquery-ui-core','jquery-ui-tabs') );

            wp_add_inline_script( 'jquery-woo_tabbed-form-processor', 
...
include_once qcld_woo_tabbed_support_path . '/qc-clr-recommendbot-support-plugin.php';
...
?>
        ...
        <div class="qcld-woo-tabbed-support qcld-support-new-page">
            ...
            <div class="qcld-plugins-lists">
                <div class="qcld-plugins-loading">
                    <img src="<?php echo esc_url(qcld_woo_tabbed_img_url); ?>/loading.gif" alt="loading">
                </div>
            </div>
        </div>
